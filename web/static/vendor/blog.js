...
var _user$project$Blog$main = {
	main: _elm_lang$html$Html$text('e from Elm')
};

var Elm = {};
Elm['Blog'] = Elm['Blog'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Blog'], 'Blog', typeof _user$project$Blog$main === 'undefined' ? null : _user$project$Blog$main);
